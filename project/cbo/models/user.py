...
class User(AbstractUser, BaseModel):
    ...
    telephone = models.CharField(max_length=15, blank=True, null=True, verbose_name='Celular')
    ...
    occupations = models.ManyToManyField('Occupation', through='UserHasOccupation', related_name='users', verbose_name='Ocupação')
    ...
    class Meta:
        indexes = [models.Index(fields=['first_name', 'occupational_registration'])]
