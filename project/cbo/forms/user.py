...
INPUT_TEXT_DEFAULT_CLASS = 'block rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-3 py-2 bg-[#F2F2F7] w-full mt-1'
...
class LoginAuthenticationForm(forms.Form):
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(attrs={
            'class': INPUT_TEXT_DEFAULT_CLASS,
    ...
    class Meta:
        ...
        widgets = {
            'email': forms.EmailInput(attrs={
                'class': 'requiredField ' + INPUT_TEXT_DEFAULT_CLASS,
                'placeholder': 'seuemail@exemplo.com',
            }),
