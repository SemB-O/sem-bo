...
from cbo.api.account.onboarding.views import (
    UserCreate,
    ValidatePessoalInfoView,
    ValidateProfissionalInfoView,
    ValidateLoginInfoView,  
)
...
urlpatterns = [
    ...
    path('users/validate/login-info/', ValidateLoginInfoView.as_view(), name='onboarding-user-validate-login-info'), 
